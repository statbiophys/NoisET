...
class longitudinal_analysis():
    ...
    def plot_hist_persistence(self, output_path, filename,  ntCDR3 = 'N. Seq. CDR3', fontsize = 12):
    ...
    def get_top_clones_set(self, n_top_clones, ntCDR3 = 'N. Seq. CDR3', clone_count = 'Clone count'):
        ...
        clones_merged = self.merged_replicates()
        top_clones = set()
        for id_, cl in clones_merged.items():
    ...
    def plot_trajectories(self, n_top_clones, output_path, filename, colormap = 'viridis', ntCDR3 = 'N. Seq. CDR3', clone_count = 'Clone count'):
    ...
    def plot_clusters2D(self, n_top_clones, output_path, filename, ntCDR3 = 'N. Seq. CDR3', clone_count = 'Clone count', nclus = 3):
    ...
    def plot_traj_clusters(self, n_top_clones, output_path, filename, ntCDR3 = 'N. Seq. CDR3', clone_count = 'Clone count', nclus = 3)
        ...
        for cl in range(n_cl):
            ...
            axs[0][cl].set_xlabel('Time', fontsize = 25)
            axs[0][cl].set_ylabel('Normalized counts', fontsize = 25)
            axs[1][cl].set_xlabel('Time', fontsize = 25)
            axs[1][cl].set_ylabel('Normalized counts', fontsize = 25)
            for traj in trajs:
...
class Generator:
    ...
    def generate_trajectories(self, tau, theta, method, paras_1, paras_2, t_ime, output_path, filename, N_readsI = '1e6', N_readsII = '1e6'):
